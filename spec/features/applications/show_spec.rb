...
RSpec.describe 'the application show', type: :features do
  ...
  let!(:pet_1) {application_1.pets.create!(name: 'Jasper', age: 7, breed: 'Maine Coon', adoptable: true )}
  let!(:pet_2) {application_2.pets.create!(name: 'Spot', age: 3, breed: 'Singapura', adoptable: true )}
